...
ASM_SRCS = $(KERNEL_ASM_SRC) $(IDT_ASM_SRC)  #kernel.asm's object file needs to be linked first in binary so that the program entry label _start will be placed at the kernel memory address start. This variable ASM_SRCS is directly passed to the linker while creating the binary
